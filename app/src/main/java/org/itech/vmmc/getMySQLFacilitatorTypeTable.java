 ...
 */
class getMySQLFacilitatorTypeTable extends AsyncTask<String, String, String> {
    ...
    getMySQLFacilitatorTypeTable(Context context, DBHelper dbhelp) {
        this.dbhelp = dbhelp;
    ...
    protected String doInBackground(String... args) {
        Log.d(LOG, "getMySQLFacilitatorTypeTable doInBackground ");
        ...
        Log.d(LOG, "getMySQLFacilitatorTypeTable username/password: " + username + " " + password);
        String datatable = "getFacilitatorType";
        try {
            URL url = null;
            try {
                url = new URL(MainActivity.GET_TABLE_URL);
                Log.d(LOG, "getMySQLFacilitatorTypeTable GET_TABLE_URL " + url.toString());
            ...
            if (success == 1) {
                ...
                for (i = 0; i < _array.length(); i++) {
                    ...
                    try {
                        ...
                        Log.d(LOG, "getMySQLFacilitatorTypeTable loop exception > " + ex.toString());
                    }
                } // foreach
            ...
            e.printStackTrace();
            Log.d(LOG, "getMySQLFacilitatorTypeTable exception > " + e.toString());
            syncAudit.set_status("getMySQLFacilitatorTypeTable exception:" + e.toString());
        }
        Log.d(LOG, "getMySQLFacilitatorTypeTable.doInBackground end");
        return Integer.toString(i);
    }

    protected void onPostExecute(String result) {
        Log.d(LOG, "getMySQLFacilitatorTypeTable:onPostExecute: " + result);
        syncAudit.set_progress("getMySQLFacilitatorTypeTable:" + result);
