 ...
 */
class getMySQLFollowupTable extends AsyncTask<String, String, String> {
    ...
    protected String doInBackground(String... args) {
        Log.d(LOG, "getMySQLFollowupTable doInBackground ");
        ...
        Log.d(LOG, "getMySQLFollowupTable username/password: " + username + " " + password);
        String datatable = "getFollowup";
        try {
            URL url = null;
            try {
                url = new URL(MainActivity.GET_TABLE_URL);
                Log.d(LOG, "getMySQLFollowupTable GET_TABLE_URL " + url.toString());
            ...
            if (success == 1) {
                ...
                for (i = 0; i < _array.length(); i++) {
                    ...
                    try {
                        ...
                        Log.d(LOG, "getMySQLFollowupTable loop exception > " + ex.toString());
                    }
                } // foreach
